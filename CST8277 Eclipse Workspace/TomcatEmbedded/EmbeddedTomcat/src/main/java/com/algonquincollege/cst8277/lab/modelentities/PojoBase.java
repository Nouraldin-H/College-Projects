...
@JsonTypeInfo(
	    ...
	    property = "type" // Defines the JSON property to distinguish subtypes
	)
	@JsonSubTypes({
	    @JsonSubTypes.Type(value = EntityA.class, name = "typeA"),
	    @JsonSubTypes.Type(value = EntityB.class, name = "typeB"),
	    @JsonSubTypes.Type(value = EntityCHasManyDees.class, name = "typeC"),
	    @JsonSubTypes.Type(value = EntityDHasManyCees.class, name = "typeD"),
	    @JsonSubTypes.Type(value = EntityEHasMany.class, name = "typeE"),
	    @JsonSubTypes.Type(value = EntityFHasManyToOneBackReference.class, name = "typeF")
	})
