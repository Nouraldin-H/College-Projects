...
public Patient(String firstName) {
	this(); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
...
public Patient(String firstName, String lastName) {
	this(firstName); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
...
public Patient(String firstName, String lastName, String gender) {
	this(firstName, lastName); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
	this.gender = gender;
}
/** Used for constructor chaining
 * @param firstName the first name of the patient 
...
public Patient(String firstName, String lastName, String gender, int birthYear) {
	this(firstName, lastName, gender); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
 ...
 */
public Patient(String firstName, String lastName, String gender, int birthYear, int birthMonth) {
	this(firstName, lastName, gender, birthYear); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
...
public Patient(String firstName, String lastName, String gender, int birthYear, int birthMonth, int birthDay) {
	this(firstName, lastName, gender, birthYear, birthMonth); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
 ...
 */
public Patient(String firstName, String lastName, String gender, int birthYear, int birthMonth, int birthDay, double height) {
	this(firstName, lastName, gender, birthYear, birthMonth, birthDay); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
	this.height = height;
}
/** Used for constructor chaining
 * @param firstName the first name of the patient 
...
public Patient(String firstName, String lastName, String gender, int birthYear, int birthMonth, int birthDay, double height, double weight) {
	this(firstName, lastName, gender, birthYear, birthMonth, birthDay, height); // needed to start the constructor chaining process from empty to full, and will continue with other following constructors.
	this.weight = weight;
}
...
//DO NOT MODIFY THIS PORTION OF CODE. IT SHOULD PRINT AS IT IS - ALREADY PROVIDED FOR YOU!!
