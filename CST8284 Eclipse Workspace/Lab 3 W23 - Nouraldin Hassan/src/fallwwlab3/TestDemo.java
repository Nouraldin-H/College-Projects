...
public class TestDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(Event1.createReport()); //print the report for the specified event, predetermined by values in EventSchedule()
		System.out.println(); //print new line

		EventSchedule Event2 = new EventSchedule(6); //EventSchedule(int year). year can be passed.
		System.out.println(Event2.createReport()); //prints passed year. other values pre-determined and printed.
		System.out.println();
		
		EventSchedule Event3 = new EventSchedule(7, 8); //EventSchedule(int year, int month). year and month can be passed.
		System.out.println(Event3.createReport()); //prints passed year and month. other values pre-determined and printed.
		System.out.println();
		
		EventSchedule Event4 = new EventSchedule(4, 5, 6); //EventSchedule(int year, int month, int day). year, month, and day can be passed.
		System.out.println(Event4.createReport()); //prints passed year, month, and day. other values pre-determined and printed.
		System.out.println();
		
		EventSchedule Event5 = new EventSchedule(9, 10, 11, "Nouraldin"); //EventSchedule(int year, int month, int day, String regName). year, month, day, and name can be passed.
		System.out.println(Event5.createReport()); //prints passed year, month, day, and name. no other values pre-determined.
		System.out.println();
		// NOTE: regName has been initialized to "unknown"

		System.out.println("Just creating 5 EventSchedules in a different way \n"); // Start to display Events in reverse order
