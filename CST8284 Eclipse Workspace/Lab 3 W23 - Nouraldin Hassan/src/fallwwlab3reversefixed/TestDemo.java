package fallwwlab3reversefixed;
...
public class TestDemo {
	...
	public static void main(String[] args) {
		...
		EventSchedule Event5 = new EventSchedule(4, 14, 49, "Nouraldin"); //EventSchedule(int year, int month, int day, String regName). year, month, day, and name can be passed.
		System.out.println(Event5.createReport()); //prints passed year, month, day, and name. no other values pre-determined.
		System.out.println();
		// NOTE: regName had been initialized to "unknown"
