 ...
 *    
 *    If you want a call of output from the empty or least complex constructor to the moxt complex constructor,
 *    you will have to hard-code some if not all of the parameters from the last constructor to the first (empty) constructor.
 *    Besides that, there is no need to have unnecessary steps as long as you only want to have reverse-chaining in a simple way (unlike this lab).
 * 
...
//Calender datetime = Calendar;
	...
	public EventSchedule(int year, int month, int day) {
		this(year, month); // use all parameters except for the last parameter for the sake of better constructor chaining showcase/display
