...
public class Car {
	public static void main(String[] args) {
		...
		Car2Info car1 = new Car2Info("Nissan", "Sentra", 2018); //default values used if CarInfo() parenthesis is left empty
		car1.printProperties(); //Calls and executes printProperties in CarInfo.java
		...
		invoiceprice = keyboard.nextDouble(); //Expects a float input
		Car2Info car2 = new Car2Info("Volkswagen", "Tiguan", 2022);
